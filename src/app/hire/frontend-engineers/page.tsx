...
export const metadata: Metadata = {
  title: "Hire Frontend Engineers from India | Workforce Next",
  description:
    "Hire pre-vetted frontend engineers from India. React, Next.js 14+, TypeScript, Tailwind CSS, and more. SethAI-screened for skills and longevity.",
  keywords: [
    ...
    "frontend staff augmentation India",
  ],
  openGraph: {
    title: "Hire Frontend Engineers from India | Workforce Next",
    description:
...
const whyPoints = [
  {
    ...
    description:
      "Our frontend engineers work with React and Next.js daily. They understand server components, streaming, and the App Router. Not just class components and Redux.",
  },
  {
    title: "Performance-first mindset",
    description:
      "Core Web Vitals, bundle splitting, lazy loading, image optimization. Our engineers build fast interfaces, not just pretty ones.",
  },
  {
    title: "Screened by SethAI for longevity",
    description:
      "SethAI evaluates ownership mindset, career alignment, and communication reliability. You get engineers who stay and build context over time.",
  },
  {
    title: "Accessibility as standard",
    description:
      "WCAG compliance, semantic HTML, keyboard navigation, and screen reader testing. Our engineers build interfaces that work for everyone.",
  },
];
...
const steps = [
  ...
  },
  {
    ...
    description:
      "Talk to the candidates directly. Assess technical ability, design sensibility, and working style.",
  },
  {
    step: "04",
      ...
      <section className="bg-gradient-to-br from-primary-50 via-white to-primary-50/50 dark:from-dark-900 dark:via-dark-900 dark:to-dark-800 pt-32 pb-16 md:pt-40 md:pb-20">
        <div className="container-custom max-w-4xl">
          ...
          <p className="mt-4 text-lg text-dark-400 dark:text-dark-300 max-w-2xl">
            Pre-vetted engineers who build fast, accessible, and maintainable
            user interfaces with React, Next.js, and TypeScript. Screened by
      ...
      <section className="section-padding bg-gradient-to-r from-primary-500 to-primary-600">
        <div className="container-custom text-center">
          ...
          <p className="text-primary-100 max-w-xl mx-auto mb-8">
            Tell us about your frontend stack and we will match you with the
