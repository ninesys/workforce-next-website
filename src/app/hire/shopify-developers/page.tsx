...
const faqItems: FAQ[] = [
  {
    ...
    answer:
      "Mid-level Shopify developers from India cost less than senior engineers with Plus, app development, or Hydrogen depth, as expected. Pricing includes engineering manager oversight and PTO backup, and we size the exact rate on a discovery call rather than publish a flat number.",
    category: "hiring",
