...
const faqItems: FAQ[] = [
  {
    ...
    answer:
      "Mid-level Flutter developers from India cost less than senior engineers with native channels, complex state, and release-engineering depth, as expected. Pricing includes engineering manager oversight and PTO backup, and we size the exact rate on a discovery call rather than publish a flat number.",
    category: "hiring",
