...
export const metadata: Metadata = {
  title: "Hire LangChain Developers from India | Workforce Next",
  description:
...
const whyPoints = [
  {
    ...
    description:
      "Our developers work with LangChain, LangGraph, and LangSmith daily. They build production chains and agents, not just notebook demos.",
  },
  {
    title: "Deep understanding of LLM patterns",
    description:
      "Chains, agents, tool use, memory management, retrieval, and structured output. Our engineers know when to use each pattern and why.",
  },
  {
    title: "Screened by SethAI for longevity",
    description:
      "SethAI evaluates ownership mindset, career alignment, and communication reliability. LLM frameworks evolve fast. You need developers who keep up.",
  },
  {
    title: "Production deployment experience",
    description:
      "Our developers have deployed LangChain applications to production with proper observability via LangSmith, error handling, and cost management.",
  },
];
