...
export const metadata: Metadata = {
  title: "Hire Data Engineers from India | Workforce Next",
  description:
    "Hire pre-vetted data engineers from India. dbt, Apache Spark, Airflow, Snowflake, Kafka, BigQuery, and more. SethAI-screened for skills and longevity.",
  keywords: [
    "hire data engineers India",
    "dbt developers India",
    "Apache Spark engineers",
    "Airflow developers",
    "Snowflake engineers India",
...
const whyPoints = [
  {
    ...
    description:
      "Our data engineers have built and maintained pipelines that process millions of records daily. They understand data quality, observability, and cost control.",
  },
  {
    title: "Modern data stack expertise",
    description:
      "From dbt transformations to Spark jobs, our engineers work across the modern data stack. They build systems that scale, not just dashboards.",
  },
  {
    title: "Screened by SethAI for longevity",
    description:
      "SethAI evaluates ownership mindset, career alignment, and communication reliability. You get engineers who stay long enough to understand your data domain.",
  },
  {
    title: "End-to-end pipeline ownership",
    description:
      "Ingestion, transformation, orchestration, testing, and monitoring. Our engineers own the full data lifecycle, not just one piece of it.",
  },
];
...
const steps = [
  {
    ...
    description:
      "Tell us about your data stack, pipeline complexity, and what kind of engineer you need.",
  },
  {
    step: "02",
  ...
  },
  {
    ...
    description:
      "Talk to the candidates directly. Assess technical ability, domain knowledge, and working style.",
  },
  {
    step: "04",
      ...
      <section className="bg-gradient-to-br from-primary-50 via-white to-primary-50/50 dark:from-dark-900 dark:via-dark-900 dark:to-dark-800 pt-32 pb-16 md:pt-40 md:pb-20">
        <div className="container-custom max-w-4xl">
          ...
          <p className="mt-4 text-lg text-dark-400 dark:text-dark-300 max-w-2xl">
            Pre-vetted engineers who build reliable data pipelines, manage
            lakehouses, and keep your analytics infrastructure running. Screened
            by SethAI for technical depth and long-term fit.
          </p>
