...
const whyPoints = [
  ...
  },
  {
    ...
    description:
      "Our engineers operate on data minimization, audit logs, and access controls aligned with the Australian Privacy Principles (APPs). Every Australian engagement signs a DPA. We can sit inside your existing privacy posture rather than punch a hole through it.",
  },
  {
    title: "No Australian entity, no sponsorship",
    description:
      "One B2B services contract with Workforce Next Pvt. Ltd. AUD invoicing. The engineer is our employee in India. You manage the work; we handle Indian payroll, PF, gratuity, equipment, and benefits. No 482 visa, no PAYG, no Australian entity needed.",
  },
];
...
const faqItems: FAQ[] = [
  ...
  },
  {
    ...
    answer:
      "No. The engineer is our employee in India and the contract is between two corporate entities (you and Workforce Next Pvt. Ltd.). We invoice in AUD. There is no employment relationship between you and the engineer, so no PAYG, no super, no 482 visa, no Australian entity, no ABN registration needed. The contract is a B2B services agreement.",
    category: "hiring",
    categoryLabel: "Hiring",
  },
  {
    ...
    <>
      ...
      <section className="section-padding bg-primary-50 dark:bg-dark-800">
        <div className="container-custom max-w-5xl">
          ...
          <p className="text-dark-600 dark:text-dark-200 leading-relaxed mb-8 max-w-3xl">
            All-in pricing in AUD. Includes our employer-side India overhead,
            equipment, payroll, and the engineering manager assigned to your
            account. The same monthly rate applies on a 3 month or 12 month
            engagement; no short-term premium.
          </p>
