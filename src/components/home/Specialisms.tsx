...
const specialisms = [
  {
    ...
    slug: "ai-developers",
    description:
      "LangChain, AutoGen, CrewAI, RAG pipelines, multi-agent systems. People who can ship production AI, not just prototype it.",
    icon: (
  ...
  },
  {
    ...
    slug: "data-engineers",
    description:
      "dbt, Spark, Airflow, Snowflake, data lakehouses. They turn messy data into pipelines you can actually rely on.",
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    description:
      "React, Next.js 14+, TypeScript. Performance-first, pixel-perfect, and comfortable cleaning up AI-generated code.",
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    description:
      "FastAPI, Node.js, Go. API-first, cloud-native backends that handle scale without drama.",
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    description:
      "They review and productionise AI-generated code from Cursor, Copilot and similar tools. Nobody else offers this.",
    isNew: true,
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    description:
      "FinOps, AWS/Azure/GCP rightsizing, Kubernetes cost reduction. They cut your cloud bill without cutting features.",
    isNew: true,
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      ...
      <div className="container-custom">
        <div className="text-center mb-10 sm:mb-14">
          ...
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-extrabold text-dark-900 dark:text-dark-50">
            Six developer specialisms
          </h2>
          <p className="mt-4 text-dark-400 dark:text-dark-300 max-w-2xl mx-auto text-base sm:text-lg">
            These aren&apos;t generic &ldquo;hire developers&rdquo; pages. Each
            specialism has its own screening criteria and SethAI matching profile.
          </p>
        </div>
