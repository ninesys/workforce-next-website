...
export const mainNavItems: NavItem[] = [
  {
    ...
    groups: [
      {
        title: "AI & Agents",
        description: "Builders for LLM apps, agents, vision, NLP, and MLOps.",
        items: [
      ...
      },
      {
        ...
        description: "Workflow automation, AI agents in production, and data engineering.",
        items: [
      ...
      },
      {
        ...
        description: "Full stack, frontend, backend, and Python/Node engineering.",
        items: [
