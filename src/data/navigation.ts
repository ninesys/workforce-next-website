...
export const mainNavItems: NavItem[] = [
  {
    ...
    groups: [
      {
        title: "1. Consulting",
        description: "Product development consulting. Architecture, stack, scope.",
        items: [
      ...
      {
        title: "2. Automation",
        description: "AI agents and workflows for business operations.",
        items: [
      ...
      {
        title: "3. Talent",
        description: "Dedicated developers and QA testers for development and testing.",
        items: [
