...
export const heroSlides: HeroSlide[] = [
  {
    badge: "AI AGENTS",
    headline: "AI Agents That Actually Deliver ROI",
    subheading:
      "95% of enterprise AI projects fail to show returns. Ours don't. We build governed, production-ready AI agents that integrate with your existing systems and scale with your business.",
  ...
  },
  {
    ...
    subheading:
      "From legacy system integration to end-to-end process orchestration, we eliminate manual bottlenecks and connect every tool in your stack. 70% average reduction in manual processing time.",
